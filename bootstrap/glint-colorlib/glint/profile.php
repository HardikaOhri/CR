...
<a href="logout.php"><button type="button" class="btn btn-info btn--primary">LOG OUT</button></a>
</div>
 <center><a href="http://localhost/bootstrap/glint-colorlib/glint/imagefinal.php"><button type="button" class="btn btn-info btn--primary">Start Business??</button></a></center>
    <!-- header
    ================================================== -->
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
                  ...
                  <li class="current"><a class="smoothscroll"  href="#Profile" title="Profile">Profile</a></li>
 ...
 <center><a href="ele1.html"><button type="button" class="btn btn-info btn--primary">Start Courses</button></a></center>
</div>
            </div>
            </div>
        </div> </section> <!-- end section-header ->
 ...
 <center><a href="imageprofile.php"><button type="button" class="btn btn-info btn--primary">Profile</button></a></center>
</div>
            </div>
            </div>
        </div> </section>
...
<center><a href="http://localhost/bootstrap/glint-colorlib/glint/forms.php"><button type="button" class="btn btn-info btn--primary">Hire Talent</button></a></center>
</div>
