...
<form action="tablu.php" method="post">
...
<!--Who can apply?
 <textarea rows="2" cols="10" name="commenttt"></textarea><br><br>
<!--Type of application
 <input type="textbox" name="type" value="" placeholder="Internship/Job"><br><br>
-->
Location:
